...
% \noindent \textit{\underline{Thread of Validity:}} CS developers are good at contributing relevant code to the system that less likely to introduce the bugs which make them more confident to spend less time on maintenance. 
...
% \noindent \textit{\underline{Thread of Validity:}} 
